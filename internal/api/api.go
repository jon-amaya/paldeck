...
func (a *api) create(w http.ResponseWriter, r *http.Request) {
	...
	if err := a.st.CreateReserving(&sv, body.GamePort, body.QueryPort, body.RconPort, body.RestApiPort, extraUDP, extraTCP); err != nil {
		status := http.StatusInternalServerError
		if body.GamePort != 0 || body.QueryPort != 0 || body.RconPort != 0 || body.RestApiPort != 0 {
